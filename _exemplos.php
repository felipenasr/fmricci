...
<main class="mdl-layout__content">
	...
	$('#example').DataTable( {
		...
		<div class="mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--4-col-phone">
			...
			<div>
				<p><span id="toll1">T</span>este</p>
				<span for="toll1" class="mdl-tooltip">Teste</span>

				<p>Teste <span id="toll2">tooltip</span></p>
				<span for="toll2" class="mdl-tooltip">Teste</span>

				<p>Teste <span id="toll3">tooltip</span></p>
				<span for="toll3" class="mdl-tooltip mdl-tooltip--large">Teste</span>
			</div>
